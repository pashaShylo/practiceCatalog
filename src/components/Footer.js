            ...
            <div className="footer__menu _container">
                <ul className="footer__list">
                    ...
                    <li className="footer__list__item">
                        <div className="phone">
                            <LocalPhoneIcon/>&nbsp;
                            <span className="number"><a className="number__link" href="tel:+380675551673">+38 067 555 1673</a></span>
                        </div>
                    </li>
                    <li className="footer__list__item"> 
                    ...
                    <li className="footer__list__item">
                        <a href="#"><YouTubeIcon sx={{color: '#F5FBFE'}}/></a>
                    </li>
                </ul>
                <div className="footer__description">ПП “YEZZ Group” 2023 Всі права захищено</div>
            </div> 
        </div>
    )
}
